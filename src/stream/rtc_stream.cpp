...
RtcStream::RtcStream(EventLoop* el, PortAllocator* allocator, uint64_t uid, const std::string& stream_name, bool audio,
...
void ice_timeout_cb(EventLoop* /*el*/, TimeWatcher* /*w*/, void* data) {
