...
void IceAgent::on_candidate_allocate_done(IceTransportChannel* channel, const std::vector<Candidate>& candidate) {
    signal_candidate_allocate_done(this, channel->transport_name(), channel->component(), candidate);
}

void IceAgent::_on_ice_receiving_state(IceTransportChannel*) { _update_state(); }

void IceAgent::_on_ice_writable_state(IceTransportChannel*) { _update_state(); }

void IceAgent::_on_ice_state_changed(IceTransportChannel*) { _update_state(); }
